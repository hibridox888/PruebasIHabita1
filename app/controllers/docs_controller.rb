<!- esta clase define los controladores que se utilizaran en las vistas de la carpeta docs, cada definicion sirve para definir parametros
...
class DocsController < ApplicationController
    ...
    def vista2 <!- define los parametros para la ventana vista2 ->
        ...
        def cambioestado <!- genera un cambio instanciado en la ventana vista2, la variable estado se actualiza al apretar el boton
        correspondiente ->
